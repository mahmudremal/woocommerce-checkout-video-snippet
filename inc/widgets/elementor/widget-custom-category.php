...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', FWPWOOCHECKOUT_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FWPWOOCHECKOUT_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', FWPWOOCHECKOUT_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FWPWOOCHECKOUT_BUILD_JS_DIR_PATH . '/widgets.js' ), true );
	}
	/**
	 * Widget key.
	 * 
