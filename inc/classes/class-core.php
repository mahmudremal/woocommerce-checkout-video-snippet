	...
	public function woocommerce_checkout_before_order_review() {
		...
		<!-- <div class="col-inner has-border">
			<div class="checkout-sidebar sm-touch-scroll"> -->
				<h3><?php esc_html_e( 'Attach a short clip.', 'woocommerce-checkout-video-snippet' ); ?></h3>
					...
					<div class="fwp-tabs__wrap">
						...
						<div class="fwp-tabs__tabs-field">
							...
							<div class="fwp-tabs__content" id="upload-video">
								<div class="fwp-dropzone-field" style="background-image: url('<?php echo esc_url( FWPWOOCHECKOUT_BUILD_URI . '/icons/drag-n-drop.svg' ); ?>');">
									<div class="fallback">
						...
						<div class="fwp-tabs__wrap">
							...
							<div class="fwp-tabs__tabs-field">
								<div class="fwp-tabs__content active" id="the-qrcode">
									<canvas class="fwp-qrzone-field" data-code="{{ data.checkout_video_clip.shortned }}"></canvas>
